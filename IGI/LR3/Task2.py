...
def run_task2():
    ...
    - Counts numbers in the range bigger then 12 using count_in_range.
    ...
    print("Эта программа подсчитывает количество чисел больше 12.")
    while True:
        ...
        try:
            ...
            print(f"Количество чисел больших 12: {count}")
